...
export function SectionCards({ stats }: { stats?: SectionCardStats }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 px-4 md:grid-cols-3 *:data-[slot=card]:bg-linear-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs lg:px-6 dark:*:data-[slot=card]:bg-card">
